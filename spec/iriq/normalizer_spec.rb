describe Iriq::Normalizer do
  describe ".normalize" do
    it "shapes path and lowercases host" do
      expect(described_class.normalize("https://FOO.com/users/123")).to eq("https://foo.com/users/{integer_id}")
    end
    ...
    it "assumes https for scheme-less inputs" do
      expect(described_class.normalize("foo.com/users/456")).to eq("https://foo.com/users/{integer_id}")
    end
    ...
    it "shapes URN values" do
      expect(described_class.normalize("urn:isbn:0451450523")).to eq("urn:isbn:{integer_id}")
    end
    ...
    it "accepts an Identifier instance" do
      ...
      expect(described_class.normalize(iri)).to eq("https://foo.com/users/{integer_id}")
    end
  end
end
