...
- Invalid UTF-8 input is a clean error (`iriq: stream did not contain valid UTF-8`, exit 1, JSON code `invalid_utf8`) instead of a Ruby backtrace. I/O errors honor `--json` in both runtimes.
